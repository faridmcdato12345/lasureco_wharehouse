...
<div class="row p-2">
    ...
    <div class="col-md-4 p-0">
        <div style="text-align: center;"><h2 style="font-weight:bolder;font-size:24px;">BLANKET WORK</h2></div>
    </div>
    <div class="col-md-4" style="text-align: right;display:inline-block;">
        ...
        <span class="voucher_code" style="display: inline-block;width:50%;text-align:center;">{{$materialVoucher}}</span>
    </div>
</div>
<div class="row">
