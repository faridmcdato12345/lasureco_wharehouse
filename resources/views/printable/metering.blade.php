...
<div class="row p-2">
    ...
    <div class="col-md-4 p-0">
        <div style="text-align: center;"><h2 style="font-weight:bolder;font-size:24px;">METERING</h2></div>
    </div>
...
<div class="row">
    <div class="col-md-4 div-4" style="display: inline-block">
        ...
        <span class="voucher_code" style="display: inline-block;width:50%;text-align:left;">{{$materialVoucher}}</span>
    </div>
...
<div class="row pt-4">
    <div class="col-md-12" style="display: inline-block">
        ...
        <span class="voucher_place" style="display: inline-block;with:85%;text-align:left;">{{$placeOfConstruction}}</span>
    </div>
</div>
