...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Blanket Voucher</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item">Voucher</li>
            <li class="breadcrumb-item active">Blanket</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="voucher-div">
                <div class="voucher-list" id="voucher-list">
                    ...
                    {{-- <form action="" method="post">
                        <button type="submit" class="btn btn-primary form-control saveToBlanket">SAVE</button>
                    </form> --}}
                    <button class="btn btn-primary form-control saveToBlanket">SAVE & PRINT</button>
                </div>
            </div>
        </div>
      </div>
...
<script>
    $(document).ready(function() {
        ...
        $('body').on('click','.addToBlanketVoucher',function () {
        ...
        $('body').on('click','.saveToVoucher',function (e) {
            let urlUpdate = "{{route('blanket.update',':id')}}";
        ...
        //save to Blanket database
        $('body').on('click','.saveToBlanket',function(){
            generateVoucherCode()
            let productid = '';
            let quantity = 0;
            ...
            $("tr.item").each(function() {
                ...
                sendToBlanketDb(voucher_id,productid,voucherNo,quantity,place,description_of_work,mctNo,issued_by,received_by,order_number,order_type)
        ...
        function undoTheQuantity(id,req){
            let urlUpdate = "{{route('blanket.undo_material',':id')}}";
        ...
        function subtractQuantity(id){
            let urlUpdate = "{{route('blanket.subtract_material',':id')}}";
            urlUpdate = urlUpdate.replace(':id',id);
            $.ajax({
                data: {
                    return_quant: 1,
        ...
        function sendToBlanketDb(voucher_id,material_id,request_voucher,quantity,place,description_of_work,mct_number,issued_by,received_by,order_number,order_type){
            let id = voucher_id
            let code = request_voucher
            let url = "{{url('/voucher/blanket/print/2/:voucherCode')}}";
