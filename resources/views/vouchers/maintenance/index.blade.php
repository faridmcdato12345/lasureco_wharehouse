...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Maintenance MCT</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-lg-5 cart">
            <div class="voucher-div">
                <div class="voucher-list" id="voucher-list">
                    ...
                    <button class="btn btn-primary form-control saveToMaintenance">SAVE & PRINT</button>
                </div>
            </div>
        </div>
      </div>
...
<script>
    $(document).ready(function() {
        ...
        $('body').on('click','.saveToVoucher',function (e) {
            let urlUpdate = "{{route('maintenance.update',':id')}}";
        ...
        $('body').on('click','.saveToMaintenance',function(){
            generateVoucherCode()
            let productid = '';
            let quantity = 0;
            ...
            $("tr.item").each(function() {
                ...
                sendToMaintenanceDb(voucher_id,productid,voucherNo,quantity,place,description_of_work,mctNo,issued_by,received_by,order_number,order_type)
        ...
        function sendToMaintenanceDb(voucher_id,material_id,request_voucher,quantity,place,description_of_work,mct_number,issued_by,received_by,order_number,order_type){
            let id = voucher_id
