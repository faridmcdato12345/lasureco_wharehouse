    ...
    $(document).ready(function() {
        ...
        $('body').on('click','.saveToMetering',function(){
            ...
            $("tr.item").each(function() {
                ...
                sendToMeteringDb(voucher_id,productid,voucherNo,quantity,place,description_of_work,mctNo,issued_by,received_by)
        ...
        function sendToMeteringDb(voucher_id,material_id,request_voucher,quantity,place,description_of_work,mct_number,issued_by,received_by){
            let id = voucher_id
