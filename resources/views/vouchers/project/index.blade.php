...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Project Voucher</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            ...
            <div class="voucher-div">
                <div class="voucher-list" id="voucher-list">
                    ...
                    {{-- <form action="" method="post">
                        <button type="submit" class="btn btn-primary form-control saveToProject">SAVE</button>
                    </form> --}}
                    <button class="btn btn-primary form-control saveToProject">SAVE & PRINT</button>
                </div>
            </div>
        </div>
      </div>
...
<script>
    $(document).ready(function() {
        ...
        function generateVoucherCode(){
            ...
            $('.voucher-number').html('PR-'+ voucherCode)
        }
        ...
        $('body').on('click','.addToProjectVoucher',function () {
        ...
        $('body').on('click','.saveToVoucher',function (e) {
            let urlUpdate = "{{route('project.update',':id')}}";
        ...
        $('body').on('click','.saveToProject',function(){
            generateVoucherCode()
            let productid = '';
            let quantity = 0;
        ...
        function undoTheQuantity(id,req){
            let urlUpdate = "{{route('project.undo_material',':id')}}";
        ...
        function subtractQuantity(id){
            let urlUpdate = "{{route('project.subtract_material',':id')}}";
            urlUpdate = urlUpdate.replace(':id',id);
            $.ajax({
                data: {
                    return_quant: 1,
