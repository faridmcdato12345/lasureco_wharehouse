    ...
    $(document).ready(function() {
        ...
        $('body').on('click','.saveToSitio',function(){
            ...
            $("tr.item").each(function() {
                ...
                sendToSitioDb(voucher_id,productid,voucherNo,quantity,place,description_of_work,mctNo,issued_by,received_by)
        ...
        function sendToSitioDb(voucher_id,material_id,request_voucher,quantity,place,description_of_work,mct_number,issued_by,received_by){
            let id = voucher_id
